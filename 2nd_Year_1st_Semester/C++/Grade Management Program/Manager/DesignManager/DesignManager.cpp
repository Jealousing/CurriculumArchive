...
const char* CDesignManager::mSubjectName[] = {"게임기획기초", "게임시나리오", "레벨디자인"}; //수업제목

CDesignManager::CDesignManager() //생성자
{
	

} 

CDesignManager::~CDesignManager() //소멸자
{

	
}

void CDesignManager::Input() //입력
{
	...
	sprintf(id, "20%s%03d", DESIGN_CODE, mStuCount + 1); // 학번을 지정
...
void CDesignManager::Display() // 출력
{
...
void CDesignManager::Search() //학생검색
{
	char id[IDSIZE]; 
	cout << "학번:";
	cin >> id; //학번검색
