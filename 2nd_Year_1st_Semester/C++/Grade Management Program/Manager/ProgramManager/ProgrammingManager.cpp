...
const char* CProgrammingManager::mSubjectName[] = { "C++2", "C#", "API2" };//수업제목

CProgrammingManager::CProgrammingManager()//생성자
{
	
}

CProgrammingManager::~CProgrammingManager()//소멸자
{
	
}

void CProgrammingManager::Input()//입력
{
	...
	sprintf(id, "20%s%03d", PROGRAM_CODE, mStuCount+1);// 학번을 지정
...
void CProgrammingManager::Display()// 출력
{	
...
void CProgrammingManager::Search()//학생검색
{
	char id[IDSIZE];	
	cout << "학번:";
	cin >> id; //학번검색
